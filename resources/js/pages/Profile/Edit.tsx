...
export default function Edit({ profile, profileCompletion }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit Profile', href: `/profile/${profile.id}/edit` }
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const hasSkills = data.skills?.filter(skill => skill && skill.trim()).length > 0;
        if (!hasSkills) {
            toast.error('Please add at least one skill before updating your profile.');
    ...
    const prepareFormData = () => {
        ...
        const filteredSkills = data.skills?.filter(skill => skill && skill.trim()) || [];
        const filteredCerts = data.certifications?.filter(cert => cert && cert.trim()) || [];

        // Filter out incomplete work experience - be less aggressive
        ...
        // Filter out incomplete education - be less aggressive
    ...
    const renderBasicInfo = () => (
        <div className="space-y-8">
            <div className="text-center">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">Update your personal details</p>
            </div>
    ...
    const renderWorkExperience = () => (
        <div className="space-y-8">
            <div className="text-center">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">Update your professional experience</p>
            </div>
    ...
    const renderEducation = () => (
        <div className="space-y-8">
            <div className="text-center">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">Update your educational background</p>
            </div>
    ...
    const renderSkillsAndCerts = () => (
        <div className="space-y-8">
            <div className="text-center">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">Update your technical abilities</p>
            </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4">
                                        ...
                                        {currentStep < steps.length - 1 ? (
                                            ...
                                            >
                                                ...
                                                <span>{processing ? 'Updating...' : 'Update Profile'}</span>
                                            </button>
                                        )}
                                    </div>
                                </div>
