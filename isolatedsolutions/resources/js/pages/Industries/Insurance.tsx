                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center py-24">
                            <div className="relative z-10 space-y-8">
                                ...
                                <p className="text-xl text-gray-300 leading-relaxed">
                                    Create innovative insurance solutions that
                                    empower businesses to provide better
                    ...
                    <MaxWidthWrapper>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                                Empowering insurance companies with innovative
                                technology
                            </p>
                        </div>
                    ...
                    <MaxWidthWrapper>
                        <div className="text-center space-y-8">
                            ...
                            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                                Let's create innovative insurance solutions for
                                your business
                            </p>
