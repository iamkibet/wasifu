                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center py-24">
                            <div className="relative z-10 space-y-8">
                                ...
                                <p className="text-xl text-gray-300 leading-relaxed">
                                    Create innovative educational solutions that
                                    empower students and educators to achieve
                    ...
                    <MaxWidthWrapper>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                                ...
                                <p className="text-gray-600 mb-6">
                                    Tools to enhance student participation and
                                    interaction
                                </p>
                                <ul className="space-y-3 text-gray-600">
                                    <li className="flex items-center gap-2">
                    ...
                    <MaxWidthWrapper>
                        <div className="text-center space-y-8">
                            ...
                            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                                Let's create innovative educational solutions
