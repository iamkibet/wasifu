                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <h1 className="text-5xl font-bold text-white leading-tight">
                                    ...
                                    <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                                        Modern Wellness Tech
                                    </span>
                                </h1>
                                <p className="text-xl text-gray-300 leading-relaxed">
                                    Create comprehensive wellness solutions that
                                    empower individuals and organizations to
                    ...
                    <MaxWidthWrapper>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                                Empowering individuals and organizations with
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                                ...
                                <p className="text-gray-600 mb-6">
                                    Customized wellness programs and initiatives
                                </p>
                                <ul className="space-y-3 text-gray-600">
                                    <li className="flex items-center gap-2">
                    ...
                    <MaxWidthWrapper>
                        <div className="text-center space-y-8">
                            ...
                            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                                Let's create innovative wellness solutions for
                                your organization
                            </p>
