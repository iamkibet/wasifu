                    ...
                    <MaxWidthWrapper>
                        <div className="relative z-10 text-center space-y-6">
                            ...
                            <p className="text-2xl text-gray-300 mt-4 max-w-3xl mx-auto leading-relaxed">
                                ...
                                and deliver exceptional shopping experiences
                            </p>
                        </div>
                    </MaxWidthWrapper>
                </section>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                                ...
                                <p className="text-gray-600">
                                    Custom eCommerce websites with advanced
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                                ...
                                <p className="text-gray-600">
                                    Native mobile apps for iOS and Android with
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                                ...
                                <p className="text-gray-600">
                                    Advanced analytics and reporting tools to
                    ...
                    <MaxWidthWrapper>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-base lg:text-lg text-slate-600 py-4 max-w-2xl mx-auto">
                                End-to-end eCommerce development services for
                                modern businesses
                            </p>
                        </div>
                    ...
                    <MaxWidthWrapper>
                        <div className="text-center space-y-8">
                            ...
                            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                                Let's build your digital commerce platform
                                together
                            </p>
